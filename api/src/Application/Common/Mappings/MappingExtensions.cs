...
public static class MappingExtensions
{
    ...
    public static Task<List<TDestination>> ToProjectToListAsync<TDestination>(this IQueryable queryable, IConfigurationProvider configuration) where TDestination : class
