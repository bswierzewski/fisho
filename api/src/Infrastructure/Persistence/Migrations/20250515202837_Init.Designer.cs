            ...
            modelBuilder.Entity("Fishio.Domain.Entities.CategoryDefinition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Zwycięzcą zostaje uczestnik, który złowił rybę o największej długości.",
                            EntityType = "FishCatch",
                            IsGlobal = true,
                            LastModified = new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Metric = "LengthCm",
            ...
            modelBuilder.Entity("Fishio.Domain.Entities.CompetitionCategory", b =>
                {
                    ...
                    b.Property<int?>("SpecificFishSpeciesId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SpecificFishSpeciesId");

                    b.HasIndex("CompetitionId", "CategoryDefinitionId")
                        .IsUnique()
                        .HasFilter("\"SpecificFishSpeciesId\" IS NULL");

                    b.HasIndex("CompetitionId", "CategoryDefinitionId", "SpecificFishSpeciesId")
                        .IsUnique()
                        .HasFilter("\"SpecificFishSpeciesId\" IS NOT NULL");
            ...
            modelBuilder.Entity("Fishio.Domain.Entities.CompetitionCategory", b =>
                {
                    ...
                    b.HasOne("Fishio.Domain.Entities.FishSpecies", "SpecificFishSpecies")
                        .WithMany()
                        .HasForeignKey("SpecificFishSpeciesId")
                    ...
                    b.Navigation("SpecificFishSpecies");
                });
