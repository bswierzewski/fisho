...
export const getUserDashboardData = (
  ...
  return customInstance<DashboardDto>({ url: `/api/dashboard`, method: 'GET', params, signal }, options);
};
...
>(
  params: GetUserDashboardDataParams,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserDashboardData>>, TError, TData>>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserDashboardData>>> = ({ signal }) =>
    getUserDashboardData(params, requestOptions, signal);
